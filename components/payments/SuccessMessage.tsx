...
export default function SuccessMessage(props: SuccessMessage) {
  return (
    <Modal visible={props.showSuccess} animationType="fade">
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center", gap: 20 }}>
        <Svg width={150} height={150} viewBox="0 0 117 117" fill="#000000">
        ...
        <View style={{ width: "100%", paddingHorizontal: 40 }}>
          <Link href={{ pathname: "/booking" }} asChild>
            <PrimaryButton buttonLabel="Back to home" />
          </Link>
        </View>
      </View>
    </Modal>
